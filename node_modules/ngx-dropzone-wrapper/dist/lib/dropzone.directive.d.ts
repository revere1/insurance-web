import { OnInit, DoCheck, OnChanges, OnDestroy, EventEmitter, NgZone, Renderer2, ElementRef, SimpleChanges, KeyValueDiffers } from '@angular/core';
...
export declare class DropzoneDirective implements OnInit, DoCheck, OnChanges, OnDestroy {
    ...
    constructor(platformId: Object, zone: NgZone, renderer: Renderer2, elementRef: ElementRef, differs: KeyValueDiffers, defaults: DropzoneConfigInterface);
    ngOnInit(): void;
    ngDoCheck(): void;
    ngOnDestroy(): void;
