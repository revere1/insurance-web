...
@Component({
  selector: 'app-editorier-comment-form',
  templateUrl: './editorier-comment-form.component.html',
  styleUrls: ['./editorier-comment-form.component.css']
})
export class EditorierCommentFormComponent implements OnInit {
  ...
  public cancel() {
    this.reply = false;
    this._router.navigate(['/analyst/insights']);
  }
