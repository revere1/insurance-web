...
@Component({
  selector: 'app-editorier-layout',
  templateUrl: './editorier-layout.component.html',
  styleUrls: ['./editorier-layout.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class EditorierLayoutComponent implements OnInit {
